...
export const metadata: Metadata = {
  title: "Product Updates | AYONIQ",
  description: "New features and product announcements from AYONIQ.",
};
...
export default async function ProductUpdatesPage() {
  let newsItems: any[] = [];
  try {
    newsItems = await client.fetch(NEWS_BY_CATEGORY_QUERY, { category: "Product" });
  } catch {
    newsItems = [];
  }
